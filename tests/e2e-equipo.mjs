...
try {
  ...
  ok(`las condiciones NUEVA llevan su etiqueta (Leo, Cristian, el primero completo, el partido que abre en Pasarela y El 33, y desde la revisión F3 «dos apoyos no se quedan solos»): ${nuevas}`, nuevas === 7, nuevas);
